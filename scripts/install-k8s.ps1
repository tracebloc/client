...
$TB_KUBELET_RESERVATION_PLATFORMS = "darwin linux"
...
$TB_KUBELET_KUBE_RESERVED_MEM_MIB_LINUX = 1120
...
$script:TbCpFootprintMemBytes = 2449473536
$script:TbCpFootprintCpuMilli = 750
