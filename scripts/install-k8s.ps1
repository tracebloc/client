...
# no limit, so the pod is BURSTABLE, not Guaranteed QoS -- see the L0.2 rationale
# at Get-TrainingLimits, which this header used to contradict outright
# (backend#2872). The old static "cpu=2,memory=8Gi"
